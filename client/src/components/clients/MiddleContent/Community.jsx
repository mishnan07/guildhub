        ...
        >
          ...
          <div className="post-container flex justify-start items-start mt-4">
            <img
              src={profile}
              alt="user"
              className="profile-photo-md float-left w-14 h-14 rounded-full"
            />
              ...
              <div className="user-info">
                <h5>
                  ...
                  <span className="following text-green-500">
                    {item.userId ? location(item.userId) : "no name"}
                  </span>
                </h5>
          ...
          <div className="flex justify-center ">
            {item.image[0] ? (
              <img
                ...
                alt="post-image"
                className="img-responsive post-image w-[350px] h-[200px] object-cover rounded-lg"
              />
            ) : (
              ""
            )}
