...
console.log(user,'=====================');
  const handleUpload = async (event) => {
    ...
    try {
      ...
      if (location.trim() === '') {
        // Validate that input2 is not empty
      ...
      formData.append('budget', budget); // Add budget value to form data
      formData.append('location', location); // Add location value to form data
