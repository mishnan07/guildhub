...
const MiddleContent = ({ Type, user, token }) => {
  ...
  return (
    <div className="md:w-1/2   overflow-scroll h-screen ">
      ...
      {/* Post Content */}
      {post
        .filter((items) => items.isActive === true && items.isBanned === false)
        .map((item) => (
          ...
          <Report />
            ...
            {deleatedId !== item._id ? (
              <div
                className="post-content bg-white p-4 mt-4 rounded-lg shadow-lg"
                key={item._id}
              >
                {/* User Info */}
                <div className="post-container flex justify-start items-start mt-4">
                  <img
                    src={profile}
                    alt="user"
                    className="profile-photo-md float-left w-10 h-10 rounded-full"
                  />
                  <div className="flex justify justify-between w-full  post-detail ml-16">
                ...
                <div className="flex justify-center items-center">
                  {item.image[0] ? (
                    <img
                      ...
                      alt="post-image"
                      className="img-responsive post-image w-[450px] h-[400px] object-cover rounded-lg"
                    />
                  ) : (
                    <video
                      controls
                      ...
                      type="video/mp4"
                      className="img-responsive post-image w-[450px] h-[450px] object-cover rounded-lg"
                    />
                  )}
                </div>
                  ...
                  <div className="reaction flex space-x-4 mt-2">
                    ...
                    <div>
                      <a className="btn text-red-500 hover:underline">
                        ...
                        {
                          comments.filter((item2) => item._id === item2.post)
                            .length
                        }
                      </a>
                    </div>
                                ...
                                <div className="flex items-center space-x-4">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <p className="text-sm font-medium text-gray-600 truncate dark:text-gray">
                                      {item.proId ? details(item1.userId) : ""}
                                    </p>
